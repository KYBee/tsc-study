...
12. [현재 구현 상태](IMPLEMENTATION_STATUS.md), [전체 텍스트 파트 앱 slice](TEXT_PARTS_APP_SLICE.md), [Part 2 로컬 시각 학습 slice](PART2_VISUAL_APP_SLICE.md), [Part 7 스토리 그림 로컬 학습 slice](PART7_STORY_VISUAL_APP_SLICE.md), [Part 4 전체 working slice](PART4_FULL_WORKING_SLICE.md), [Part 4 로컬 검수 워크플로](PART4_REVIEW_WORKFLOW.md)
