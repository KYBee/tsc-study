...
Part 4 개발 fixture는 `data/working/app-fixtures/part4/`에 생성된다. 이는 검수 완료 또는 배포용 데이터가 아니라 `data/working/question-sample/questions.csv`의 raw 표본 6개만 변환한 개발 입력이다. 원본 CSV와 Excel은 수정하지 않는다.
