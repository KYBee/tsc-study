...
1. [데이터 스키마 v1 요약](docs/SCHEMA_V1_SUMMARY.md)과 [상세 스키마](docs/DATA_SCHEMA.md)를 검토한다.
2. 스키마 v1에 맞춘 전체 반입 규칙과 검수 범위를 정한다.
3. 원본 내부의 출처 주장과 링크·이미지 공개 가능 여부를 별도로 확인한다.
4. 전체 추출 전에 기준 데이터 형식과 구현 기술을 별도로 결정한다.
